...
public class RSSIEventTest {
    ...
    public void parseHCIEventPacket() throws Exception {
        Optional<RSSIEvent> o = RSSIEvent.parsePacket("C8:69:CD:3E:20:F1", TestConstants.HCI_EVENT);
        RSSIEvent e = o.orElse(new RSSIEvent("a", Integer.MAX_VALUE));
    ...
    public void parseBTMONPacket() throws Exception {
        Optional<RSSIEvent> o = RSSIEvent.parsePacket("C8:69:CD:83:BD:E7", TestConstants.BT_MON_EVENT);
        RSSIEvent e = o.orElse(new RSSIEvent("a", Integer.MAX_VALUE));
